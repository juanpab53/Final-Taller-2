export class BookRepository {
  async findAll(filters, page, limit) { throw new Error('BookRepository.findAll not implemented.'); }
  async findById(id) { throw new Error('BookRepository.findById not implemented.'); }
